...
//  }
  public MyStatusMessage(String localNodeId, Discover.Endpoint endpoint,int maxConnNum,int connNum,int networkId){
    super(MessageType.STATUS, null);
    byte[] nodeId = MyUtil.hexStringToByteArray(localNodeId);
    this.statusMessage = Connect.StatusMessage.newBuilder()
            .setFrom(endpoint)
            .setMaxConnections(maxConnNum)
            .setCurrentConnections(connNum)
  ...
  public int getMaxConnections() {
    return this.statusMessage.getMaxConnections();
  }
  public int getCurrentConnections() {
    return this.statusMessage.getCurrentConnections();
  }
